...
|使用案例 | Use Case Diagram | 捕捉系統的企業需求，並說明系統與環境之間的互動關係 | 分析 | [Chapter5_ActivityDiagram](https://github.com/RickyJian/LinuxClassNote/blob/master/OOSADNoteChap5_Activity.md)<br>[Chapter5_InteractionOverviewDiagram](https://github.com/RickyJian/LinuxClassNote/blob/master/OOSADNoteChap5_InteractionOverview.md) <br>[Chapter5_UseCaseDiagram](https://github.com/RickyJian/LinuxClassNote/blob/master/OOSADNoteChap5_UseCaseDiagram.md)   |
